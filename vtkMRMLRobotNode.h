...
// Description:
  ...
  virtual bool GetNeedleDirectionAtTarget(vtkLITTPlanTargetDescriptor *targetDesc, NeedleDescriptorStruct *needle, double* needleDirection) { return false; };

  virtual bool ShowRobotAtTarget(vtkLITTPlanTargetDescriptor *targetDesc, NeedleDescriptorStruct *needle) { return false; };
  //BTX
  virtual std::string GetTargetInfoText(vtkLITTPlanTargetDescriptor *targetDesc, NeedleDescriptorStruct *needle) { return ""; };
