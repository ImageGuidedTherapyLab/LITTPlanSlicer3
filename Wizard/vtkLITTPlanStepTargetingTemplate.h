...
#ifndef __vtkLITTPlanStepTargetingTemplate_h
#define __vtkLITTPlanStepTargetingTemplate_h
...
class VTK_PROSTATENAV_EXPORT vtkLITTPlanStepTargetingTemplate : public vtkLITTPlanStep
{
public:
  static vtkLITTPlanStepTargetingTemplate *New();
  vtkTypeRevisionMacro(vtkLITTPlanStepTargetingTemplate,vtkLITTPlanStep);
...
protected:
  vtkLITTPlanStepTargetingTemplate();
  ~vtkLITTPlanStepTargetingTemplate();
...
private:
  vtkLITTPlanStepTargetingTemplate(const vtkLITTPlanStepTargetingTemplate&);
  void operator=(const vtkLITTPlanStepTargetingTemplate&);
};
