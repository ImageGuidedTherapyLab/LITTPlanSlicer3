#ifndef __vtkLITTPlanFiducialCalibrationStep_h
#define __vtkLITTPlanFiducialCalibrationStep_h
...
class vtkMRMLLaserApplicatorNode;


#include "vtkSmartPointer.h"

class VTK_PROSTATENAV_EXPORT vtkLITTPlanFiducialCalibrationStep :
  public vtkLITTPlanStep
{
public:
  static vtkLITTPlanFiducialCalibrationStep *New();
  vtkTypeRevisionMacro(vtkLITTPlanFiducialCalibrationStep,
                       vtkLITTPlanStep);
...
protected:
  vtkLITTPlanFiducialCalibrationStep();
  ~vtkLITTPlanFiducialCalibrationStep();
  ...
  vtkMRMLLaserApplicatorNode* GetRobot();  
  ...
  vtkMRMLLaserApplicatorNode* ObservedRobot;
  vtkMRMLFiducialListNode* ObservedCalibrationPointListNode;

private:  
  vtkLITTPlanFiducialCalibrationStep(const vtkLITTPlanFiducialCalibrationStep&);
  void operator=(const vtkLITTPlanFiducialCalibrationStep&);
};
