...
//----------------------------------------------------------------------------
vtkStandardNewMacro(vtkLITTPlanCalibrationStep);
vtkCxxRevisionMacro(vtkLITTPlanCalibrationStep, "$Revision: 1.1 $");

//----------------------------------------------------------------------------
vtkLITTPlanCalibrationStep::vtkLITTPlanCalibrationStep()
{
...
//----------------------------------------------------------------------------
void vtkLITTPlanCalibrationStep::ShowUserInterface()
{
...
//----------------------------------------------------------------------------
void vtkLITTPlanCalibrationStep::HideUserInterface()
{
...
//----------------------------------------------------------------------------
void vtkLITTPlanCalibrationStep::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void vtkLITTPlanCalibrationStep::ProcessGUIEvents(vtkObject *caller,
...
//----------------------------------------------------------------------------
void vtkLITTPlanCalibrationStep::ShowZFrameModel(bool show)
{
  ...
  vtkMRMLModelNode*  modelNode = vtkMRMLModelNode::SafeDownCast(this->MRMLScene->GetNodeByID(this->GetLITTPlanManager()->GetRobotNode()->GetCalibrationObjectModelId()));
...
/*
//----------------------------------------------------------------------------
const char* vtkLITTPlanCalibrationStep::AddZFrameTransform(const char* nodeName)
{
  std::string rstr;
  ...
  transformNode->SetDescription("Created by LITTPlan module");
...
//----------------------------------------------------------------------------
void vtkLITTPlanCalibrationStep::PerformZFrameCalibration(const char* filename)
{
  ...
  if ( m != NULL ) 
  {
    ...
    if (volumeNode)
    {
      this->GetLITTPlanManager()->GetRobotNode()->PerformRegistration(volumeNode);
    }
  }
  else
  {
...
//----------------------------------------------------------------------------
void vtkLITTPlanCalibrationStep::PerformZFrameCalibration(vtkMRMLScalarVolumeNode* node, int s_index, int e_index)
{
  if (node)
    {
    this->GetLITTPlanManager()->GetRobotNode()->PerformRegistration(node, s_index, e_index);
    }
...
//-----------------------------------------------------------------------------
void vtkLITTPlanCalibrationStep::AddGUIObservers()
{
...
//-----------------------------------------------------------------------------
void vtkLITTPlanCalibrationStep::RemoveGUIObservers()
{
  if (this->CalibrateButton)
    {
