...
//----------------------------------------------------------------------------
vtkStandardNewMacro(vtkLITTPlanStepSetUp);
vtkCxxRevisionMacro(vtkLITTPlanStepSetUp, "$Revision: 1.1 $");

//----------------------------------------------------------------------------
vtkLITTPlanStepSetUp::vtkLITTPlanStepSetUp()
{
...
//----------------------------------------------------------------------------
void vtkLITTPlanStepSetUp::ShowUserInterface()
{
...
//----------------------------------------------------------------------------
void vtkLITTPlanStepSetUp::PrintSelf(ostream& os, vtkIndent indent)
{
  this->Superclass::PrintSelf(os,indent);
}

//----------------------------------------------------------------------------
void vtkLITTPlanStepSetUp::ProcessGUIEvents( vtkObject *caller,
...
vtkMRMLTransPerinealProstateRobotNode* vtkLITTPlanStepSetUp::GetRobotNode()
{
  if (this->LITTPlanManager==NULL)
  {
    return NULL;
  }
  vtkMRMLTransPerinealProstateRobotNode* robotNode = vtkMRMLTransPerinealProstateRobotNode::SafeDownCast(this->LITTPlanManager->GetRobotNode());
  return robotNode;
}
