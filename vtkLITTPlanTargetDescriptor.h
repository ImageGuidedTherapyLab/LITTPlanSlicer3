...
=========================================================================auto=*/
// .NAME vtkLITTPlanTargetDescriptor - describes the target, along with targeting paramteres and validation info
// .SECTION Description
// vtkLITTPlanTargetDescriptor describes the target, along with targeting paramteres and validation info

#ifndef _vtkLITTPlanTargetDescriptor_h
#define _vtkLITTPlanTargetDescriptor_h
#pragma once
...
class VTK_PROSTATENAV_EXPORT vtkLITTPlanTargetDescriptor :
  public vtkObject
{
public:

  static vtkLITTPlanTargetDescriptor *New();
  vtkTypeRevisionMacro(vtkLITTPlanTargetDescriptor,vtkObject);
  void PrintSelf(ostream& os, vtkIndent indent);

  void DeepCopy(vtkLITTPlanTargetDescriptor& src);
...
private:
  ...
  vtkLITTPlanTargetDescriptor(void);
  ~vtkLITTPlanTargetDescriptor(void);

  vtkLITTPlanTargetDescriptor(const vtkLITTPlanTargetDescriptor&);
  void operator=(const vtkLITTPlanTargetDescriptor&);
};
