...
//    std::cerr << "void vtkLITTPlanLogic::TimerHandler() is called" << std::endl;
    return 1;
}
...
int vtkMRMLTransPerinealProstateRobotNode::SendZFrame()
{
  ...
  std::cerr << "int vtkLITTPlanLogic::SendZFrame(): " << this->GetZFrameTransformNodeID() << std::endl;
...
//----------------------------------------------------------------------------
std::string vtkMRMLTransPerinealProstateRobotNode::GetTargetInfoText(vtkLITTPlanTargetDescriptor *targetDesc, NeedleDescriptorStruct *needle)
{
