...
//----------------------------------------------------------------------------
vtkStandardNewMacro(vtkLITTPlanTargetDescriptor);
vtkCxxRevisionMacro(vtkLITTPlanTargetDescriptor, "$Revision: 1.0 $");

//----------------------------------------------------------------------------
vtkLITTPlanTargetDescriptor::vtkLITTPlanTargetDescriptor()
{
...
//----------------------------------------------------------------------------
vtkLITTPlanTargetDescriptor::~vtkLITTPlanTargetDescriptor(void)
{
}

//----------------------------------------------------------------------------
void vtkLITTPlanTargetDescriptor::DeepCopy(vtkLITTPlanTargetDescriptor& src)
{
  this->Name=src.Name;
...
//----------------------------------------------------------------------------
void vtkLITTPlanTargetDescriptor::PrintSelf(ostream& os, vtkIndent indent)
{
