...
#ifndef __vtkLITTPlanGUI_h
#define __vtkLITTPlanGUI_h
...
class vtkMRMLLITTPlanManagerNode;
class vtkMRMLFiducialListNode;
 
// Description:    
// This class implements Slicer's Volumes GUI
//
class VTK_PROSTATENAV_EXPORT vtkLITTPlanGUI : public vtkSlicerModuleGUI
{
 public:
 ...
 public:
  ...
  static vtkLITTPlanGUI* New (  );
  vtkTypeRevisionMacro ( vtkLITTPlanGUI, vtkSlicerModuleGUI );
  ...
  void SetAndObserveModuleLogic ( vtkLITTPlanLogic *logic )
  ...
  vtkMRMLLITTPlanManagerNode* GetLITTPlanManagerNode();
 ...
 protected:
  vtkLITTPlanGUI ( );
  virtual ~vtkLITTPlanGUI ( );
  
  //void SetLITTPlanManager(vtkMRMLLITTPlanManagerNode* node);
  ...
  vtkLITTPlanStep* GetStepPage(int i);
  ...
  vtkSlicerNodeSelectorWidget* LITTPlanManagerSelectorWidget;
 ...
 private:
  ...
  vtkLITTPlanGUI ( const vtkLITTPlanGUI& ); // Not implemented.
  void operator = ( const vtkLITTPlanGUI& ); //Not implemented.
  ...
  void SetAndObserveLITTPlanManagerNodeID(const char *nodeID);  
  ...
  vtkSetStringMacro(LITTPlanManagerNodeID);
  char* LITTPlanManagerNodeID;
  vtkMRMLLITTPlanManagerNode* LITTPlanManagerNode;
